...
class TwigExtension extends \Twig_Extension {
  ...
  private function addComponentFrontEndBuilderMarkup($renderer, $_context, $componentInstanceUuid) {
    ...
    if(!isset($_context['component_content']) && !isset($_context['hideContextualLinks']) && !isset($_context['isPreview']) && $this->hasDrupalPermission(["access contextual links", "access components"])) {
      $build[] = [
        '#type' => 'container',
        '#attributes' => array(
